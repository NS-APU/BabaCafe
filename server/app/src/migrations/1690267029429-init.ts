...
export class migrations1690267029429 implements MigrationInterface {
  name = 'migrations1690267029429';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "logistics_setting_for_intermediary" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "intermediary_id" uuid NOT NULL, "stop" character varying(50) NOT NULL, CONSTRAINT "REL_bfc8e61b842fe421aa8473f2dd" UNIQUE ("intermediary_id"), CONSTRAINT "PK_2cf537324358402df29a50087cd" PRIMARY KEY ("id")); COMMENT ON COLUMN "logistics_setting_for_intermediary"."id" IS 'ID'; COMMENT ON COLUMN "logistics_setting_for_intermediary"."intermediary_id" IS '引渡し業者ID'; COMMENT ON COLUMN "logistics_setting_for_intermediary"."stop" IS '最寄りのバス停'`,
    );
    await queryRunner.query(
      `CREATE TABLE "timetable" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trip_id" uuid NOT NULL, "stop" character varying(50) NOT NULL, "time" TIMESTAMP NOT NULL, CONSTRAINT "PK_06001d91b3fe346fb1387ad1a15" PRIMARY KEY ("id")); COMMENT ON COLUMN "timetable"."id" IS 'ID'; COMMENT ON COLUMN "timetable"."trip_id" IS '便ID'; COMMENT ON COLUMN "timetable"."stop" IS '停車場所'; COMMENT ON COLUMN "timetable"."time" IS '時刻'`,
    );
    await queryRunner.query(
      `CREATE TABLE "trip" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "route_id" uuid NOT NULL, "name" character varying(50) NOT NULL, "shock_level" integer NOT NULL, "capacity" integer NOT NULL, CONSTRAINT "PK_714c23d558208081dbccb9d9268" PRIMARY KEY ("id")); COMMENT ON COLUMN "trip"."id" IS 'ID'; COMMENT ON COLUMN "trip"."route_id" IS '路線ID'; COMMENT ON COLUMN "trip"."name" IS '便名称'; COMMENT ON COLUMN "trip"."shock_level" IS '衝撃度合い'; COMMENT ON COLUMN "trip"."capacity" IS '最大取扱量'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "logistics_setting_for_producer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "producer_id" uuid NOT NULL, "stop" character varying(50) NOT NULL, CONSTRAINT "REL_ea4946d052ea2ea9870faae3a5" UNIQUE ("producer_id"), CONSTRAINT "PK_033b326cac0c588c5ae6b53dd1f" PRIMARY KEY ("id")); COMMENT ON COLUMN "logistics_setting_for_producer"."id" IS 'ID'; COMMENT ON COLUMN "logistics_setting_for_producer"."producer_id" IS '生産者ID'; COMMENT ON COLUMN "logistics_setting_for_producer"."stop" IS '最寄りのバス停'`,
    );
    await queryRunner.query(
      `CREATE TABLE "shipping_schedule" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "logistics_id" uuid NOT NULL, "logistics_name" character varying(30) NOT NULL, "route_id" uuid NOT NULL, "route_name" character varying(50) NOT NULL, "trip_id" uuid NOT NULL, "trip_name" character varying(50) NOT NULL, "pickup_stop" character varying(50) NOT NULL, "pickup_time" TIMESTAMP NOT NULL, "delivery_stop" character varying(50) NOT NULL, "delivery_time" TIMESTAMP NOT NULL, "reservation_ids" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_a14f1a2c6029aaed09f889c56ea" PRIMARY KEY ("id")); COMMENT ON COLUMN "shipping_schedule"."id" IS 'ID'; COMMENT ON COLUMN "shipping_schedule"."logistics_id" IS '物流業者ID'; COMMENT ON COLUMN "shipping_schedule"."logistics_name" IS '物流業者名'; COMMENT ON COLUMN "shipping_schedule"."route_id" IS '路線ID'; COMMENT ON COLUMN "shipping_schedule"."route_name" IS '路線名'; COMMENT ON COLUMN "shipping_schedule"."trip_id" IS '便ID'; COMMENT ON COLUMN "shipping_schedule"."trip_name" IS '便名'; COMMENT ON COLUMN "shipping_schedule"."pickup_stop" IS '集荷場所'; COMMENT ON COLUMN "shipping_schedule"."pickup_time" IS '集荷予定時刻'; COMMENT ON COLUMN "shipping_schedule"."delivery_stop" IS '配送場所'; COMMENT ON COLUMN "shipping_schedule"."delivery_time" IS '配送予定時刻'; COMMENT ON COLUMN "shipping_schedule"."reservation_ids" IS '出荷予約ID一覧'; COMMENT ON COLUMN "shipping_schedule"."created_at" IS '作成日時'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "timetable" ADD CONSTRAINT "FK_716aed18c06200589de562239a5" FOREIGN KEY ("trip_id") REFERENCES "trip"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trip" ADD CONSTRAINT "FK_7403b82a4b74cc97d12e3c06fa4" FOREIGN KEY ("route_id") REFERENCES "route"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reservation" ADD CONSTRAINT "FK_3a1bae4087af20f978abf36307e" FOREIGN KEY ("shipping_schedule_id") REFERENCES "shipping_schedule"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "reservation" DROP CONSTRAINT "FK_3a1bae4087af20f978abf36307e"`);
    ...
    await queryRunner.query(`ALTER TABLE "trip" DROP CONSTRAINT "FK_7403b82a4b74cc97d12e3c06fa4"`);
    await queryRunner.query(`ALTER TABLE "timetable" DROP CONSTRAINT "FK_716aed18c06200589de562239a5"`);
    await queryRunner.query(
