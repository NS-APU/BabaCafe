...
export class migrations1690267029429 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "shipping_schedule" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "logistics_id" uuid NOT NULL, "logistics_name" character varying(30) NOT NULL, "route_id" uuid NOT NULL, "route_name" character varying(50) NOT NULL, "trip_id" uuid NOT NULL, "trip_name" character varying(50) NOT NULL, "pickup_stop" character varying(50) NOT NULL, "pickup_time" TIMESTAMP NOT NULL, "delivery_stop" character varying(50) NOT NULL, "delivery_time" TIMESTAMP NOT NULL, "reservations" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_a14f1a2c6029aaed09f889c56ea" PRIMARY KEY ("id")); COMMENT ON COLUMN "shipping_schedule"."id" IS 'ID'; COMMENT ON COLUMN "shipping_schedule"."logistics_id" IS '物流業者ID'; COMMENT ON COLUMN "shipping_schedule"."logistics_name" IS '物流業者名'; COMMENT ON COLUMN "shipping_schedule"."route_id" IS '路線ID'; COMMENT ON COLUMN "shipping_schedule"."route_name" IS '路線名'; COMMENT ON COLUMN "shipping_schedule"."trip_id" IS '便ID'; COMMENT ON COLUMN "shipping_schedule"."trip_name" IS '便名'; COMMENT ON COLUMN "shipping_schedule"."pickup_stop" IS '集荷場所'; COMMENT ON COLUMN "shipping_schedule"."pickup_time" IS '集荷予定時刻'; COMMENT ON COLUMN "shipping_schedule"."delivery_stop" IS '配送場所'; COMMENT ON COLUMN "shipping_schedule"."delivery_time" IS '配送予定時刻'; COMMENT ON COLUMN "shipping_schedule"."reservations" IS '出荷予約ID一覧'; COMMENT ON COLUMN "shipping_schedule"."created_at" IS '作成日時'`,
    );
    await queryRunner.query(
